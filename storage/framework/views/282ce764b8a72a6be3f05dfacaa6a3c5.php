<?php $__env->startSection('title', 'Kata Sandi Baru'); ?>
...
<div class="login-container">
    <div class="login-card">
        ...
        <div class="text-center mb-4">
            ...
            <p class="text-secondary small mb-0">Silakan masukkan kata sandi baru Anda (minimal 8 karakter)</p>
        </div>
        ...
        <form action="<?php echo e(route('password.update')); ?>" method="POST" id="resetForm" onsubmit="handleFormSubmit(event)">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-3">
                ...
                <div class="input-group-custom">
                    ...
                    <input type="password" class="form-control-custom" id="password" name="password" placeholder="********" required autofocus>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dimas\mini-lms-classroom\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>