    ...
    <?php if(count($group['tasks']) > 0): ?>
        <div class="card border-0 shadow-sm rounded-4 bg-white overflow-hidden">
            ...
            <div class="px-4 py-3 d-flex align-items-center gap-3 <?php echo e(!$loop->last ? 'border-bottom' : ''); ?>">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('courses.show', $task->course_id)); ?>" class="btn btn-sm text-white" style="font-size: 0.8rem; background-color: <?php echo e($task->course->color); ?>; border-radius: 6px; padding: 0.3rem 0.75rem; font-weight: 600; border: none;">
                        Kerjakan
                    </a>
                <?php endif; ?>
            </div>
