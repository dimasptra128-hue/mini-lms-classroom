...
<div class="login-container">
    <div class="login-card">
        ...
        <form action="<?php echo e(route('register')); ?>" method="POST" id="registerForm" onsubmit="handleFormSubmit(event)">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-3">
                ...
                <div class="input-group-custom">
                    ...
                    <input type="text" class="form-control-custom" id="name" name="name" placeholder="Nama Lengkap Anda" value="<?php echo e(old('name')); ?>" required autofocus>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group-custom">
                    ...
                    <input type="email" class="form-control-custom" id="email" name="email" placeholder="nama@gmail.com" value="<?php echo e(old('email')); ?>" required>
                </div>
            </div>
        ...
        <div class="text-center mt-3" style="font-size: 0.85rem; color: #64748b;">
            Sudah punya akun? <a href="<?php echo e(route('login')); ?>" class="text-link-custom">Masuk Sekarang</a>
        </div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\mini-lms-classroom\resources\views/auth/register.blade.php ENDPATH**/ ?>