...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Beranda'); ?> - <?php echo e(config('app.name', 'Mini LMS')); ?></title>
...
<div class="sidebar-container d-none d-lg-flex">
    <div>
        <div class="sidebar-logo-section">
            <a href="<?php echo e(route('dashboard')); ?>" class="d-flex align-items-center gap-2 text-decoration-none mb-1">
        ...
        <ul class="sidebar-menu-list">
            <li><a href="<?php echo e(route('dashboard')); ?>" class="sidebar-link <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>"><i class="bi bi-grid-1x2"></i> Dashboard</a></li>
            <li><a href="<?php echo e(route('courses')); ?>" class="sidebar-link <?php echo e(request()->routeIs('courses') ? 'active' : ''); ?>"><i class="bi bi-journal-bookmark"></i> Kelas Saya</a></li>
            <li><a href="<?php echo e(route('tasks')); ?>" class="sidebar-link <?php echo e(request()->routeIs('tasks') ? 'active' : ''); ?>"><i class="bi bi-calendar-event"></i> Tugas</a></li>
            <li><a href="<?php echo e(route('report')); ?>" class="sidebar-link <?php echo e(request()->routeIs('report') ? 'active' : ''); ?>"><i class="bi bi-file-earmark-bar-graph"></i> Nilai</a></li>
            <li><a href="<?php echo e(route('settings')); ?>" class="sidebar-link <?php echo e(request()->routeIs('settings') ? 'active' : ''); ?>"><i class="bi bi-gear"></i> Pengaturan</a></li>
            <?php if(Auth::check() && Auth::user()->isAdmin()): ?>
            <li style="margin-top: 0.5rem; padding-top: 0.5rem; border-top: 1px solid #e2e8f0;">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.*') ? 'active' : ''); ?>" style="color: #7c3aed;">
...
<div class="main-wrapper">
    ...
    <header class="main-header">
        ...
        <div class="header-left">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="header-brand-title">Mini LMS</a>
            <!-- Nav links hidden on mobile -->
            <a href="<?php echo e(route('tasks')); ?>" class="header-nav-link d-none d-md-inline <?php echo e(request()->routeIs('tasks') ? 'fw-semibold text-dark' : ''); ?>">Tugas</a>
            <a href="<?php echo e(route('report')); ?>" class="header-nav-link d-none d-md-inline <?php echo e(request()->routeIs('report') ? 'fw-semibold text-dark' : ''); ?>">Nilai</a>
        </div>
...
<div class="modal fade" id="modalGabungKelas" tabindex="-1" aria-labelledby="modalGabungKelasLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width: 420px;">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
            ...
            <form action="<?php echo e(route('courses.join')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\dimas\mini-lms-classroom\resources\views/layouts/app.blade.php ENDPATH**/ ?>