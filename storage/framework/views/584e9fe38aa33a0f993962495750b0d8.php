...
<div class="mb-4">
    <a href="<?php echo e(route('courses.show', $course->id)); ?>" class="d-inline-flex align-items-center gap-1 text-decoration-none fw-semibold text-secondary transition-all" style="font-size: 0.88rem;">
        <i class="bi bi-arrow-left"></i> Kembali ke Kelas <?php echo e($course->name); ?>
    ...
    <div class="col-lg-8 col-12">
            ...
            <div class="d-flex align-items-start gap-3 border-bottom pb-4 mb-4 justify-content-between flex-wrap flex-md-nowrap">
                <div class="d-flex align-items-center gap-3">
                    <div class="rounded-3 d-flex align-items-center justify-content-center flex-shrink-0"
                        ...
                        <i class="bi bi-clipboard-check-fill" style="color: <?php echo e($course->color); ?>; font-size: 1.6rem;"></i>
                    </div>
                    <div>
                        <span class="text-secondary small fw-medium" style="font-size: 0.8rem;">Tugas Kelas</span>
                        <h4 class="fw-bold text-dark mb-1" style="font-size: 1.4rem; letter-spacing: -0.01em;"><?php echo e($task->title); ?></h4>
                        <div class="d-flex align-items-center gap-2 text-secondary" style="font-size: 0.78rem;">
                            <span>Oleh: <strong><?php echo e($course->teacher_name); ?></strong></span>
                            <span>·</span>
                            <span>Diposting <?php echo e($task->created_at->diffForHumans()); ?></span>
                        </div>
                    </div>
                </div>
                <div class="text-md-end text-start mt-2 mt-md-0 flex-shrink-0">
                    <div class="fw-semibold text-danger" style="font-size: 0.88rem;">Tenggat: <?php echo e($task->due_date); ?></div>
                    <span class="text-secondary small">100 Poin</span>
                    <?php if($userRole === 'teacher'): ?>
                        <div class="d-flex gap-2 mt-3">
                            <a href="<?php echo e(route('tasks.showSubmissions', [$course->id, $task->id])); ?>" class="btn btn-sm btn-outline-primary rounded-3 px-3 fw-semibold" style="font-size: 0.78rem;">
                                <i class="bi bi-file-earmark-check me-1"></i> Kelola Penilaian
                            </a>
                            <form action="<?php echo e(route('tasks.delete', [$course->id, $task->id])); ?>" method="POST" class="d-inline">
                                <?php echo csrf_field(); ?>
                    ...
                    <div class="p-3 rounded-4 border d-flex align-items-center justify-content-between hover-shadow transition-all bg-light bg-opacity-30">
                        <div class="d-flex align-items-center gap-3 min-width-0">
                            ...
                            <div class="min-width-0">
                                <div class="fw-semibold text-dark text-truncate small" style="max-width: 320px;"><?php echo e($task->file_name); ?></div>
        ...
        <div class="card border-0 shadow-sm rounded-4 bg-white p-4 p-md-5" id="comments">
            <h6 class="fw-bold text-dark mb-4 d-flex align-items-center gap-2" style="font-size: 1rem;">
                <i class="bi bi-chat-dots-fill" style="color: <?php echo e($course->color); ?>;"></i>
                Komentar &amp; Jawaban
                <span class="badge rounded-pill fw-semibold ms-1" style="background-color: <?php echo e($course->color); ?>15; color: <?php echo e($course->color); ?>; font-size: 0.72rem;">
            ...
            <?php $commentArchivedFlag = isset($isCourseArchived) ? $isCourseArchived : ($course->is_archived ?? false); ?>
            <?php if(!$commentArchivedFlag): ?>
            <form action="<?php echo e(route('comments.store', [$course->id, 'tasks', $task->id])); ?>" method="POST" class="mb-4">
                <?php echo csrf_field(); ?>
                ...
                <div class="d-flex gap-3 align-items-start">
                    ...
                    <div class="flex-grow-1">
                        <textarea class="form-control" name="body" rows="2"
                                  placeholder="<?php echo e($userRole === 'teacher' ? 'Tulis balasan atau klarifikasi untuk tugas ini...' : 'Tulis jawaban singkat atau pertanyaan terkait tugas ini...'); ?>"
                                  ...
                                  onfocus="this.style.borderColor='<?php echo e($course->color); ?>'; this.style.boxShadow='0 0 0 3px <?php echo e($course->color); ?>20';"
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-2">
                            ...
                            <button type="submit" class="btn btn-sm text-white px-4 py-2 rounded-3 fw-semibold"
                                    style="background-color: <?php echo e($course->color); ?>; border: none; font-size: 0.82rem;">
                        ...
                        <div class="flex-grow-1">
                            <div class="p-3 rounded-4 comment-bubble">
                                <div class="d-flex align-items-center gap-2 mb-1 flex-wrap">
                                    <span class="fw-bold text-dark" style="font-size: 0.85rem;"><?php echo e(optional($comment->user)->name ?? ($comment->name ?? 'Pengguna')); ?></span>
                                    <?php if($comment->user_id === $course->creator_id): ?>
                                        <span class="badge rounded-pill" style="background-color: <?php echo e($course->color); ?>15; color: <?php echo e($course->color); ?>; font-size: 0.68rem; font-weight: 600;">Pengajar</span>
                                    <?php endif; ?>
                                    <span class="text-secondary" style="font-size: 0.73rem;"><?php echo e(isset($comment->created_at) ? \Carbon\Carbon::parse($comment->created_at)->diffForHumans() : ''); ?></span>
                                </div>
                                <?php if(!empty($comment->reply_to) && isset($commentsById[$comment->reply_to])): ?>
                                    <div class="mb-2 rounded-3 py-2 px-3 comment-reply-indicator">
                                        <span class="text-secondary small">Balasan untuk <strong><?php echo e(optional($commentsById[$comment->reply_to]->user)->name ?? ($commentsById[$comment->reply_to]->name ?? 'Komentar')); ?></strong></span>
                                    </div>
                                <?php endif; ?>
                                <p class="text-dark mb-0 comment-body" style="font-size: 0.88rem; line-height: 1.6; white-space: pre-line;"><?php echo e($comment->body ?? ''); ?></p>
                                <div class="mt-3 d-flex justify-content-end">
                                    <button type="button" class="btn btn-sm btn-link text-secondary" onclick="setReply(<?php echo e($comment->id); ?>, '<?php echo e(addslashes(optional($comment->user)->name ?? ($comment->name ?? 'Pengguna'))); ?>')">
    ...
    <div class="col-lg-4 col-12">
        ...
        <div class="card border-0 shadow-sm rounded-4 bg-white p-4 mb-4">
            <div class="d-flex align-items-center justify-content-between mb-3 pb-2 border-bottom">
                ...
                ?>
                <?php if($userSubmission && data_get($userSubmission, 'status') === 'Selesai'): ?>
            ...
            <?php if($userSubmission && data_get($userSubmission, 'status') === 'Selesai'): ?>
                <div class="py-3 text-center">
                    ...
                    <p class="text-secondary mb-3" style="font-size: 0.75rem;">Diserahkan pada <?php echo e(\Carbon\Carbon::parse(data_get($userSubmission, 'submitted_at', now()))->isoFormat('D MMM YYYY')); ?></p>
                    <?php if(data_get($userSubmission,'file_path')): ?>
                        <div class="mb-2">
                            <a href="<?php echo e(asset('storage/' . data_get($userSubmission,'file_path'))); ?>" download class="btn btn-sm btn-outline-secondary w-100 rounded-3 small mb-2">Unduh Kiriman</a>
                        </div>
                    <?php endif; ?>
                        ...
                        <div class="border-top pt-3 mt-3">
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-center justify-content-center gap-2 mt-2">
                                    <span class="fw-bold" style="font-size: 1.8rem; color: <?php echo e($score >= 80 ? '#16a34a' : ($score >= 70 ? '#b45309' : '#dc2626')); ?>;">
                                        <?php echo e($score); ?>

                                    </span>
                                    <span class="badge rounded-pill py-2" 
                                          style="background-color: <?php echo e($score >= 90 ? '#dcfce7; color: #16a34a' : ($score >= 80 ? '#fef3c7; color: #b45309' : '#fee2e2; color: #dc2626')); ?>; font-size: 0.8rem; font-weight: 600;">
                                        Grade <?php echo e($score >= 90 ? 'A' : ($score >= 80 ? 'B' : ($score >= 70 ? 'C' : ($score >= 60 ? 'D' : 'E')))); ?>
                            ...
                            <?php if($feedback): ?>
                                <div class="rounded-3 p-3 mb-0 feedback-box">
                                    ...
                                    <p class="text-dark small mb-0" style="font-size: 0.85rem; white-space: pre-wrap;"><?php echo e($feedback); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php else: ?>
                    ...
                    <?php if(!$isSubmissionBlocked): ?>
                        <form action="<?php echo e(route('tasks.cancelSubmission', [$course->id, $task->id])); ?>" method="POST" class="mt-3">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
            ...
            <?php else: ?>
                <?php if($isSubmissionBlocked): ?>
                    <div class="py-4 text-center">
                        <div class="rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3" style="width: 50px; height: 50px; background-color: <?php echo e($isCourseArchived ? '#fef3c7' : '#fee2e2'); ?>;">
                            <i class="fs-4 <?php echo e($isCourseArchived ? 'bi bi-archive-fill text-warning' : 'bi bi-lock-fill text-danger'); ?>"></i>
                        </div>
                        <p class="text-dark fw-bold small mb-1"><?php echo e($isCourseArchived ? 'Kelas Diarsipkan' : 'Pengumpulan Ditutup'); ?></p>
                ...
                <?php else: ?>
                    <div class="py-2">
                        <form id="submitForm" action="<?php echo e(route('tasks.submit', [$course->id, $task->id])); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
                            ...
                            <button id="submitBtn" type="submit" class="btn text-white w-100 rounded-3" style="background-color: <?php echo e($course->color); ?>; font-weight: 600; font-size: 0.85rem; border: none; padding: 0.6rem;">
        ...
        <div class="card border-0 shadow-sm rounded-4 bg-white p-4">
            <h6 class="fw-bold text-dark border-bottom pb-3 mb-3" style="font-size: 0.95rem; color: <?php echo e($course->color); ?> !important;">
                Info Kelas
            </h6>
            <div class="mb-3">
                <h6 class="fw-bold text-dark mb-0" style="font-size: 0.9rem;"><?php echo e($course->name); ?></h6>
                <span class="text-secondary" style="font-size: 0.72rem;"><?php echo e($course->level); ?></span>
            </div>
            <div class="d-flex flex-column gap-2 small text-secondary border-top pt-3">
                <div class="d-flex justify-content-between">
                    <span>Pengajar:</span>
                    <span class="text-dark fw-medium"><?php echo e($course->teacher_name); ?></span>
                </div>
                <div class="d-flex justify-content-between">
                    <span>Kode Kelas:</span>
                    <span class="text-dark font-monospace fw-bold text-uppercase"><?php echo e($course->code); ?></span>
                </div>
            </div>


            <?php if($otherTasks->count() > 0): ?>
            <div class="border-top mt-3 pt-3">
                <div class="fw-bold text-dark mb-2" style="font-size: 0.82rem;">Tugas Lainnya</div>
                <div class="d-flex flex-column gap-1">
                    <?php $__currentLoopData = $otherTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $otherTask): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('tasks.show', [$course->id, $otherTask->id])); ?>"
                           class="d-flex align-items-center gap-2 text-decoration-none p-1 rounded-3 hover-bg-light transition-all">
                            <i class="bi bi-clipboard-check" style="color: <?php echo e($course->color); ?>; font-size: 0.85rem;"></i>
                            <span class="text-dark small text-truncate" style="font-size: 0.8rem;"><?php echo e($otherTask->title); ?></span>
                        </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mini-lms-classroom\resources\views/task_details.blade.php ENDPATH**/ ?>