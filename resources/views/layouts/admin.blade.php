...
<head>
    ...
    <title>@yield('title', 'Admin Panel') - {{ config('app.name', 'Mini LMS') }}</title>
...
<div class="sidebar-container d-none d-lg-flex">
    <div>
        <div class="sidebar-logo-section">
            <a href="{{ route('admin.dashboard') }}" class="d-flex align-items-center gap-2 text-decoration-none mb-1">
...
<div class="main-wrapper">
    ...
    <header class="main-header">
        ...
        <div class="header-left">
            ...
            <a href="{{ route('admin.dashboard') }}" class="header-brand-title text-danger">Admin Panel</a>
        </div>
